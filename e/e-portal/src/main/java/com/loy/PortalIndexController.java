...
public class PortalIndexController {
    ...
    public IndexData getIndexData() {
        ...
        List<TreeNode> menuData = securityUserService
                .getMenuByUsername(userSessionService.getSessionUser().getId(), lang);
        Map<String, Boolean> access = indexData.getAccessCodes();
        List<Permission> resources = securityUserService
                .findPermissionsByUsername(userSessionService.getSessionUser().getUsername());
