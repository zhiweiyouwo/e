    	 ...
    	 if(settings.getRecordOperateLog()){
    		 try{
    	         ...
    	         if(controllerLogExeTime.log()){
    	        	 ...
    	        	 if(user != null){
    	        		 loyLogService.log(systemKeyService.getSystemCode(),user.getId(), user.getName(),description , args);
    	        	 }else{
			        		...
			        		if("login".equals(methodName)){
			        			 ...
			        			 if(u != null){
			        				 loyLogService.log(systemKeyService.getSystemCode(),u.getId(), u.getName(),description , temp); 
			        			 }
			        		} 
    	        	 }
    	         }
     ...
     public Object timeAroundAdvice( ProceedingJoinPoint joinPoint) throws Throwable{
    	 ...
    	 try{
    		 ...
    		 if(controllerLogExeTime.exeTime()){
            	 ...
            	 loyLogService.record(systemKeyService.getSystemCode(),url,method.toString(),endTime,controllerLogExeTime.description());
    		 }
    	 }catch(Throwable e){
