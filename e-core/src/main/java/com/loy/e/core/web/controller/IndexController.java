...
public class IndexController {
    ...
    public IndexData getIndexData() {
        ...
        List<TreeNode> menuData = securityUserService.getMenuByUsername(
                userSessionService.getSessionUser().getId(), systemKeyService.getSystemCode(),
                lang);
        Map<String, Boolean> access = indexData.getAccessCodes();
        List<Permission> resources = securityUserService.findPermissionsByUsername(
                userSessionService.getSessionUser().getUsername(),
